...
\begin{itemize}
	...
	\item tuning based on the first 1000 segments of test corpus
\end{itemize}
Tunable parameters:
\begin{itemize}	
	\item Word penalty (WP) \& TDP
\end{itemize}
...
\begin{center}
	\begin{tabular}{| l | c |} \toprule
		WP/TDP      &    WER [\%]    \\ \midrule
		80/1-0-10   &    5           \\
		80/2-0-20   &\color{red}{4.2}\\
		80 /3-0-30  &    4.27        \\ \midrule
		80 /10-0-10 &    7.11        \\
		100/20-0-20 &    22.56       \\
		120/30-0-30 &    36.54       \\ \bottomrule
...
\begin{itemize}
  ...
  \item \color{red}{also show WER and SER results in this slide for search}
\end{itemize}
...
Search & RTF 1 thread & RTF 4 threads  \\ \midrule
GMM    & 0.21         & 0.08           \\
NN     &              &                \\ \bottomrule
\end{tabular}
}
...
\begin{itemize}
	\item In our experiments, GMMs clearly outperform NNs in both speed and error rates
\end{itemize}
\vfill
