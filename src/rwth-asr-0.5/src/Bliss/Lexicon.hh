...
// $Id: Lexicon.hh 8249 2011-05-06 11:57:02Z rybach $
...
namespace Bliss {
	...
	LemmaPronunciation(Id _id) : id_(_id) {}
    public:
	 ...
	 */
	Core::Ref<Fsa::Automaton> createLemmaToOrthographyTransducer(bool shallIncludeVariants = true) const;
