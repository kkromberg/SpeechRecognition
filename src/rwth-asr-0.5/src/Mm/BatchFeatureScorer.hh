...
protected:
    /**
     * Stores the current feature and the number of buffered feature.
     * All compuations are done in BatchFeatureScorer.
     * This class acts is used only because it is required by the
...
public:
   ...
   /**
    * Return a scorer for the current feature and apppend the
