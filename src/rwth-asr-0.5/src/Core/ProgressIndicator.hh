...
// $Id: ProgressIndicator.hh 5439 2005-11-09 11:05:06Z bisani $
...
namespace Core {
    ...
    /** Provide assurance to impacient users.
     *
     ...
     * read".  Indeally you know the total number of these "work
     ...
     *   at any time.
     * - There are no provisions for thead safety.
     *
     * TODO:
     * - Should detect if cout is conneted to a TTY, and suppress
     *   messages otherwise.
     * - see Limitations
     */
	 ...
	 * @param task a terse description of the operation, which is
	 * @param align indicate wether description should be left or right aligned
	 * displayed to the left of the progress indicator.
	 */
	 ...
	 * You may call notify() very freuqently, e.g. from your inner
	...
	/**
	 * Indicate the current state of operation and update estmate
